/**
 * Auto-generated uint16 SIMD bit-packing/unpacking.
 * Generated by gen_simdbitpacking_u16.py --mode guarded
 *
 * Unpack mode: GUARDED — compile-time toggle via SIMD_SUM_FUSED.
...
#else
  _mm_storeu_si128((__m128i *)out, InReg);
  out += 8;
#endif
  InReg = _mm_loadu_si128(++in);
#ifdef SIMD_SUM_FUSED
